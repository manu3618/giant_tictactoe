//! # Giant Tic Tac Toe
//!
//! This is an implentation of Giant TicTacToe.
//!
//! To play, run
//!
//! ```bash
...
/// Play a game of giant TicTacToe
///
/// Retruns the winner (Cross or Circle)
pub fn run_game() -> Space {
